      ...
      client.manager
        .on("playerCreate", async (player) => {
            ...
            try {
              ...
              embed.addField(`🎵 Power by lavalink`, `**[Invite their Public Bot](https://discord.com/api/oauth2/authorize?client_id=882975441156202526&permissions=8&scope=bot%20applications.commands)  •  [WEBSITE](https://flamebot)**`)
            } catch {}
